...
var Sync = Composer.Model.extend({
	...
	{
		this.enabled = true;
		this.bind('db->mem', this.run_outgoing_sync.bind(this), 'sync:model:db->mem');
		this.bind('mem->db', this.start_outgoing_sync.bind(this), 'sync:model:mem->db');
	...
	{
		this.local_tackers[name] = tracker;
	},
