...
var translation = {
	...
	"{{email}} isn't registered with Turtl. It's recommended to protect the invite with a passphrase to keep it private.": "{{email}} ne possède pas de compte Turtl. Il est recommendé de protéger l'invitation avec un mot de passe pour qu'elle reste privée.",
