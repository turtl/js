...
var translation = {
	...
	"": ", porém você tem {{length}} modificações esperando para serem sincronizadas que serão perdidas se você continuar",
	"": "[Fazer links](https://turtlapp.com) é fácil!",
	"": "{{email}} tem uma conta verificada e este convite será encriptado usando a chave pública dela.",
	"": "{{email}} tem uma conta Turtl, mas ela não foi verificada. É possível proteger o convite com uma senha para mantê-lo privado.",
