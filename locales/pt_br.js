...
var translation = {
	...
	"(This process can take a while because we need to re-encrypt your keychain)": "(Este processo pode demorar um pouco, porque precisamos re-encriptar sua keychain)",
	...
	"{{email}} has a confirmed account and this invite will be encrypted using their public key.": "{{email}} tem uma conta verificada e este convite será encriptado usando a chave pública dela.",
	"{{email}} has a Turtl account, but it is not confirmed. You may want protect the invite with a passphrase to keep it private.": "{{email}} tem uma conta Turtl, mas ela não foi verificada. É possível proteger o convite com uma senha para mantê-lo privado.",
	"": "{{email}} não tem uma conta Turtl. É recomendado proteger o convite com uma senha para mantê-lo privado.",
	"": "{{n}} dias atrás",
	"": "{{n}} horas atrás",
	"": "{{n}} minutos atrás",
	"": "{{n}} segundos atrás",
	"": "<strong>Erro:</strong> {{errmsg}} ({{errcode}})",
	"": "Observações sobre como Turtl funciona",
	"": "Aceitar",
	"": "Adicionar",
	"": "Adicionar um novo URL Favorito",
	"": "Adicionar um novo arquivo",
	"": "Adicionar uma nova imagem",
	"": "Adicionar uma nova nota",
	"": "Adicionar uma nova senha",
	"": "Adicionar uma nova nota de texto",
	"": "Configurações avançadas",
	"": "Todas as notas",
	"": "Você tem certeza que quer deletar sua conta e todos os seus dados <em>para sempre</em>?",
	"": "Anexar um arquivo",
	"": "Voltar às minhas notas",
	"": "Bloqueado por sincronizações paradas.",
	"": "Título do quadro",
	"": "Quadros",
	"": "URL favorito",
	"": "URL Favorito",
	...
	"": "Mudar login",
	"": "Mudar senha",
	"": "Mudar sua senha requere que esteja conectado.",
	"": "Apagar todos os filtros atuais (mostrar todas as notas no quadro)",
	"": "Apagar dados locais",
	"": "Apagar dados locais e deslogar",
	"": "Versão do cliente: <em>{{version}}</em>",
	"": "vírgulas, separam, etiquetas",
	"": "Apagar completamente perfil atual antes de importar",
	"": "Confirmar senha",
	"": "Confirmar login atual",
	"": "Confirmação de email re-enviada",
	"": "Conectado",
	"": "Conectado ao serviço Turtl! Desativando modo offline. Sincronizando seu perfil.",
	...
	"Create board in {{space}}": "Criar um quadro em",
	...
	"": "Deletar nota atual",
	"": "Deletar minha conta",
	"Delete sync item": "Deletar item sincronizado",
	"Delete this board": "Deletar este quadro",
	"Delete this space &raquo;": "Deletar este espaço &raquo;",
	"Disconnected from the Turtl service. Engaging offline mode. Your changes will be saved and synced once back online!": "Disconectado do serviço Turtl. Ativando modo offline. Suas modificações serão salvas e sincronizadas quando você ficar online novamente!",
	...
	"Enter a new email/password": "Digite um novo email/password",
	"Error": "Erro",
	"Error loading profile": "Erro carregando perfil",
	"excellent": "excelente",
	"Export": "Exportar",
	"Feedback": "Feedback",
	"file": "arquivo",
	...
	"Find a note by hitting <kbd>/</kbd> and typing your search followed by <kbd>Enter</kbd>. The note search box supports <a href=\"https://sqlite.org/fts3.html#full_text_index_queries\" target=\"_blank\">Sqlite's FTS3 syntax</a>.": "Ache uma nota com <kbd>/</kbd> e digitando os termos de pesquisa seguidos de <kbd>Enter</kbd>. A caixa de pesquisa de notas suporta a <a href=\"https://sqlite.org/fts3.html#full_text_index_queries\" target=\"_blank\">sintaxe FTS3 do Sqlite</a>.",
	"Formatting help": "Ajuda de formação",
	"From {{user}}": "De {{user}}",
	"Frozen - This item is blocking syncing. Fix by unfreezing or deleting.": "Congelado - Este item está bloqueando a sincronização. Conserte descongelando ou deletando.",
	"Give us feedback": "Nos dar feedback",
	"Give your feedback": "Dar seu feedback",
	"good": "bom",
	"Grabbed {{num_keychain}} keychain entries, {{num_boards}} boards, {{num_notes}} notes, {{num_files}} files from old server": "Resgatados {{num_keychain}} registros da keychain, {{num_boards}} quadros, {{num_notes}} notas, {{num_files}} arquivos do servidor antigo",
	"great": "ótimo",
	...
	"New bookmark": "Nova URL favorita",
	...
	"Please enter some feedback": "Por favor, digite seu feedback",
	...
	"Prev": "Anterior",
	"Quote text with a caret": "Cite texto com um circunflexo",
	...
	"Really delete this sync item? Doing this will undo a change you've made locally (try unfreezing first).": "Realmente deletar este item sincronizado? Fazer isso irá desfazer modificações que você localmente (tente descongelar primeiro).",
	"Really delete this user from this space?": "Realmente deletar este usuário deste espaço?",
	"Really hand ownership of this space to another member? (You will be demoted to admin)": "Realmente entregar a posse deste espaço para outro membro?",
	...
	"Select the color for this space": "Selecione a cor para esse espaço",
	...
	"Share this space &raquo;": "Compartilhar este espaço &raquo;",
	...
	"Sync info": "Informação de sincronização",
	"Tag note": "Etiquetar nota",
	"Tap <em>+</em> to start": "Clique em <em>+</em> para começar",
	"text note": "nota de texto",
	"Text note": "Nota de texto",
	"Text search": "Busca de texto",
	"Thanks!": "Obrigado!",
	"That board doesn't seem to exist": "Esse quadro não parece existir",
	"That passphrase is making me cringe.": "Essa senha está me deixando com vergonha.",
	...
	"There was a problem clearing your profile": "Ocorreu um problema ao apagar seu perfil",
	"There was a problem deleting that invite": "Ocorreu um problema ao deletar aquele convite",
	"There was a problem deleting that sync item": "Ocorreu um problema ao deletar aquele item sincronizado",
	...
	"There was a problem unfreezing that sync item": "Ocorreu um problema ao descongelar aquele item sincronizado",
	...
	"There was an error syncing a local change and syncing is paused. Click to open your sync settings and fix &raquo;": "Ocorreu um problema ao sincronizar uma modificação local e sincronizações estão pausadas. Clique nas suas configurações de sincronização e conserte &raquo;",
	...
	"This note was saved incorrectly and cannot be displayed.\n\n```\n{{-note_data}}\n```\n": "Esta nota foi salva incorretamente e não pode ser mostrada.\n\n```\n{{-note_data}}\n```\n",
	"This passphrase is used to encrypt the invite. You can communicate it to the invitee via a secure channel (in-person, encrypted email, encrypted chat, etc).": "Essa senha é usada para encriptar o convite. Você pode passá-la para o convidado por um método seguro (em pessoa, email encriptado, chat encriptado, etc).",
	"This process can take a while.": "Este processo pode demorar um pouco.",
	...
	"Trouble logging in?": "Está com problemas para logar?",
	...
	"Two hashes for a smaller header": "Dois hashs para um cabeçalho menor",
	"Unfreeze sync item": "Descongelar item sincronizado",
	"Unlock": "Destravar",
	...
	"You can also make text __bold__, *italic* or ~~strikethrough~~.": "Você também pode fazer texto __em negrito__, *itálico* ou ~~riscado~~.",
	"You can also make text <strong>bold</strong>, <em>italic</em> or <strike>strikethrough</strike>.": "Você também pode fazer texto <strong>em negrito</strong>, <em>itálico</em> ou <strike>riscado</strike>.",
	...
	"You do not have permissions to move boards/notes to that space.": "Você não tem permissões para mover quadros/notas para esse espaço.",
	"You do not have permissions to move notes to that space.": "Você não tem permissões para mover notas para esse espaço.",
	...
	"You have {{num}} pending sync item(s)": "Você tem {{num}} item(ns) sincronizado(s) pendente(s)",
	"You have no pending invitations": "Você não tem convites pendentes",
	"You have one or more frozen sync items. Syncing will be stuck until you fix them. Try unfreezing first, and if that doesn't work, you can delete the frozen sync item(s).": "Você tem um ou mais itens sincronizados congelados. Sincronização ficará travada até que você os conserte. Tente descongelá-los primeiro, e se isso não funcionar, você pode deletar os itens sincronizados congelados.",
	...
	"You must confirm your account before accepting invites.": "Você precisa verificar sua conta antes de aceitar convites.",
	"You must confirm your account before accepting invites. If you no longer have your confirmation email, you can resend it from the Settings menu.": "Você precisa verificar sua conta antes de aceitar convites. Se você não tem mais acesso ao seu email de confirmação, você pode reenviá-lo do menu de Configurações.",
