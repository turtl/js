...
( function( window, factory ) {
  ...
  if ( typeof define == 'function' && define.amd ) {
    ...
    define( 'outlayer/outlayer',[
      ...
      function( EvEmitter, getSize2, utils, Item ) {
        return factory( window, EvEmitter, getSize2, utils, Item);
      }
    );
  } else if ( typeof module == 'object' && module.exports ) {
    // CommonJS - Browserify, Webpack
...
}( window, function factory( window, EvEmitter, getSize2, utils, Item ) {
'use strict';
...
// -------------------------- masonryDefinition -------------------------- //
  ...
  proto.measureColumns = function() {
    ...
    if ( !this.columnWidth ) {
      ...
      this.columnWidth = firstItemElem && getSize2( firstItemElem ).outerWidth ||
